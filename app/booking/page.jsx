...
export default function Page() {
  ...
  return (
    <div className="h-screen  w-screen  ">
      ...
      <div className="booking_container   flex justify-between items-start">
        <div className="updates booking  flex justify-center items-start w-update_w p-5  flex-col">
          {" "}
          ...
          <div className="  my-5 overflow-y-scroll messages_container w-full">
        ...
        <div className="booking z-[-1] h-full flex justify-start items-center w-96  p-5 border-l-black border-l-2 border-l-solid  flex-col">
          ...
          <div className="overflow-y-scroll h-96 border border-black">
